...
import { postComment } from "store/guitar/asyncActions";
import { getGuitar } from "store/guitar/selectors";
import { useAsyncDispatch } from "hooks/useAsyncDispatch";
import { CommentToServer } from "types/guitar";
...
export const CommentModal = (props: CommentModalProps) => {
  ...
  const [status, post] = useAsyncDispatch({
    onLoad: (comment: CommentToServer) => postComment(comment),
  ...
  const onFormSubmit = (data: FormValues) => {
    ...
    const { name, rating, advantage, disadvantage, comment } = data;
